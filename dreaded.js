...
const botname = process.env.BOTNAME || '𝐎𝐖𝐋 𝐀𝐈';
...
const maindev2 = maindev.split(",");
    ...
    const packname = process.env.STICKER_PACKNAME || '𝐀𝐈';
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: `https://github.com/owlai01/Owl-Ai`,
                                mediaType: 1,
...
case "ping": case "speed": { 
         m.reply (`${dreadedspeed.toFixed(4)} ms`); 
         } 
 break; 
  
 case "runtime": { 
                 m.reply (`Owl AI Bot active for ${runtime(process.uptime())}`) 
 } 
 break;

case "alive": { 
  
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/1d0fb63c857138f5bee51.jpg' }, caption: `Hello ${m.pushName}, 𝐎𝐖𝐋 𝐀𝐈 is active\n\nActive for:  ${runtime(process.uptime())}\n\nType ${prefix}help.\n\nYou can also interact with our online chatbot built with html and JavaScript with API integration.\n\nLink is given below:\n\nhttps://quantumlab.ru.eu.org/`, fileLength: "9999999999898989899999999" }, { quoted: m }); 
 }
break;
case 'apk': {
...
case "movie": 
 ...
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/1d0fb63c857138f5bee51.jpg' }, caption: `You can deploy this bot using the github link below!\nFork and give us a star ✨.\n\nhttps://github.com/owlai01/Owl-Ai` }, {quoted: m}); 
  
 break; 
 
          case "owl": case "owner": case "sirm": 
 client.sendMessage(m.chat, { video: { url: 'https://imgur.com/a/qbn8k5F.mp4' }, caption: `Say no more 😌 here is the owl ai owner  contact +254743551416 🥱` }, {quoted: m}); 
